...
class Config(object):
    ...
    def __init__(self, dataset):
        self.model_name = 'roberta-german-checkpoint-96'
        ...
        self.roberta_checkpoint = './models--Sheripov--deid-roberta-i2b2-fine-tuned-german/checkpoint-96'  # 指定checkpoint目录
...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.roberta = RobertaModel.from_pretrained(config.roberta_checkpoint)  # 用checkpoint替代预训练路径
